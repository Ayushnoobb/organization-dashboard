...
export const GetAllCandidateByVotingStageIdSlice = createSlice( {
...
export const { resetState } = GetAllCandidateByVotingStageIdSlice.actions
export const GetAllCandidatesByVotingCampaignData = (state : RootStore) => state.get_all_candidates_by_stage_id
export default GetAllCandidateByVotingStageIdSlice.reducer